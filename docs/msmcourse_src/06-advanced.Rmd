...
```{tikz, fig.cap = "Hidden Markov model", fig.ext = 'png', echo=FALSE}
...
This is a (partially) hidden Markov model, hence can be implemented in `msm`.
...
- Several R packages available for random effects models with _time-to-event_ data - see the [CRAN task view](https://cran.r-project.org/web/views/Survival.html).
