...
9.30 to 12.30 French time (8.30 to 11.30 UK time)

Balance of lectures and practical exercises 

All the course material is available at 

[http://chjackson.github.io/msm/msmcourse](http://chjackson.github.io/msm/msmcourse)
...
* [Part 6. Advanced topics](#advanced) (for reference, but may not be time)


## Prerequisites {-}

Laptop with R and the `msm` package installed 
